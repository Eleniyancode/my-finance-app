function SaveToPotForm({ setShowSaveToPotForm }) {
  return (
    <section className="bg-white w-full max-w-md mx-3 p-6 rounded-lg">
      <div className="flex justify-between ">
        ...
        <button
          onClick={() => setShowSaveToPotForm(false)}
      ...
      <form>
        ...
        <div className="flex justify-between items-center gap-1 mb-4">
          ...
          <p className="text-3xl font-bold">$559.00</p>
        </div>

        <div className="my-4 bg-[rgb(248,244,240)] flex gap-1 rounded-lg w-full h-2">
          <div className="bg-black w-[5%] rounded-lg"></div>
          <div className="bg-green-700 w-[15%] rounded-lg"></div>
        </div>
        <div className="flex mb-5 justify-between font-public-sans ">
          <p className="text-green-900">27.95%</p>
