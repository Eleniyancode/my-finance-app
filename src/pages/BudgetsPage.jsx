function BudgetsPage() {
  return (
    <>
      ...
      <div className="py-6 px-4 md:p-10 bg-[rgb(248,244,240)]  lg:grid lg:grid-cols-5 w-screen">
        ...
        <section className="mt-8 pt-8 pb-3 px-4 bg-white rounded-lg md:flex">
            ...
            <ul className="flex flex-col gap-5 md:text-[18px]">
              <li className="flex p-2 font-public-sans border-b border-b-gray-100">
                ...
                <p className="flex-2 flex justify-end gap-2 items-center">
                  <span className="font-public-sans-bold text-md">$250.00</span>{" "}
              ...
              <li className="flex p-2 font-public-sans border-b border-b-gray-200">
                ...
                <p className="flex-2 flex justify-end gap-2 items-center">
                  <span className="font-public-sans-bold text-md">$67.00</span>{" "}
              ...
              <li className="flex p-2 font-public-sans border-b border-b-gray-200">
                ...
                <p className="flex-1 flex justify-end gap-2 items-center">
                  <span className="font-public-sans-bold text-md">$65.00</span>{" "}
              ...
              <li className="flex p-2 font-public-sans border-b border-b-gray-100">
                ...
                <p className="flex-2 flex justify-end gap-2 items-center">
                  <span className="font-public-sans-bold text-md">$25.00</span>{" "}
          ...
          <div className="mt-8">
            ...
            <ul className="mt-8 mx-1 px-4 py-4 bg-[rgb(248,244,240)] rounded-md flex flex-col gap-4">
              <div className="flex justify-between">
                <p className="font-public-sans-bold text-md">Latest Spending</p>
              ...
              <li className="flex justify-between items-center border-b text-[14px] border-gray-200 pb-4">
                <div className="flex justify-center items-center gap-3">
                  <p className="font-public-sans-bold">Romoe Cloud Service</p>
                </div>
        ...
        <section className="mt-8 mx-1 px-4 py-4 bg-white rounded-lg">
          <div className="flex justify-between items-center">
            <div className="flex justify-between items-center gap-4">
              ...
              <h3 className="font-public-sans text-lg font-bold">Bills</h3>
            </div>
            <div>
              <img src="../images/icon-ellipsis.svg" alt="icon-ellipsis" />
            </div>
          ...
          <div className="mt-8">
            ...
            <ul className="mt-8 mx-1 px-2 py-4 bg-[rgb(248,244,240)] rounded-md flex flex-col gap-4">
              ...
              <li className="flex justify-between text-[14px] items-center border-b border-gray-200 pb-4">
                <div className="flex justify-center items-center gap-3">
                  <p className="font-public-sans-bold">Foxtrot Waterline</p>
                </div>

                <div className="flex flex-col gap-2">
                  <p className="text-right font-public-sans-bold">-$100.50</p>
                  <p className="text-right text-gray-500">19 Aug 2024</p>
                </div>
              </li>
              <li className="flex justify-between text-[14px] items-center border-b border-gray-200 pb-4">
                <div className="flex justify-center items-center gap-3">
                  <p className="font-public-sans-bold">Tango Gas Company</p>
                </div>
        ...
        <section className="mt-8 pt-8 pb-3 px-4 bg-white rounded-lg">
          <div className="flex justify-between items-center">
            <div className="flex justify-between items-center gap-4">
              ...
              <h3 className="font-public-sans text-lg font-bold">Dining Out</h3>
            </div>
            <div>
              <img src="../images/icon-ellipsis.svg" alt="icon-ellipsis" />
            </div>
